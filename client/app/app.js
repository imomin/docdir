...
angular.module('sugarlandDoctorsApp', [
  ...
  .factory('specialistItems', function(CommonData) {
    var items = [];
    var itemsService = {};

    itemsService.set = function(list) {
      items = list;
    };
  ...
  .run(function ($q, $rootScope, $location, $window, $templateCache, $http, CommonData, Auth, socket, validator, defaultErrorMessageResolver,bootstrap3ElementModifier,beforeUnload, specialistItems) {
